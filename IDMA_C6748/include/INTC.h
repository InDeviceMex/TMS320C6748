...
extern void INTC__vVectorTable (void);
extern void INTC__vDspInit (void);
extern Intc_nStatus INTC__enCpuIntRegisterRoutine (Intc_nMask enCpuInt, void (*userISR)(void));
extern Intc_nStatus INTC__enCpuIntUnRegisterRoutine (Intc_nMask enCpuInts);
extern Intc_nStatus INTC__enCpuNmiEnable (Intc_nMask enCpuInt);
extern Intc_nStatus INTC__enCpuIntEnable (Intc_nMask enCpuInt);
extern Intc_nStatus INTC__enCpuNmiDisable (Intc_nMask enCpuInt);
extern Intc_nStatus INTC__enCpuIntDisable (Intc_nMask enCpuInt);
extern void INTC__enCpuIntReset (void);

extern Intc_nStatus INTC__enEventMap2CpuInt (Intc_nMask enCpuInt, Intc_nEvent enSysInt);
extern Intc_nStatus INTC__enEventSet (Intc_nEvent enSysInt);
extern Intc_nStatus INTC__enEventClear (Intc_nEvent enSysInt);
extern Intc_nStatus INTC__enEventCombineAdd(Intc_nEvent enSysInt);
extern Intc_nStatus INTC__enEventCombineRemove(Intc_nEvent enSysInt);
extern Intc_nStatus INTC__enEventCombineRegisterRoutine(Intc_nEvent enSysInt, void (*userISR)(void));
extern Intc_nStatus INTC__enEventCombineInit(Intc_nMask enEcmInt0, Intc_nMask enEcmInt1, Intc_nMask enEcmInt2, Intc_nMask enEcmInt3);


#define INTC__vIntGlobalEnable()     _enable_interrupts()
#define INTC__u32IntGlobalDisable()  _disable_interrupts()
#define INTC__vIntGlobalRestore(restoreValue) _restore_interrupts(restoreValue)

extern void INTC__vExceptionGlobalEnable (void);
extern Intc_nStatus INTC__enExceptionCombineAdd(Intc_nEvent enSysInt);
extern Intc_nStatus INTC__ExceptionCombineRemove(Intc_nEvent enSysInt);
