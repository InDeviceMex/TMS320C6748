...
IMAGPROC_nStatus IMAGEPROC__en16bRGBScale_8bGreenScale(LCDC_TFT_TypeDef *restrict psLayerSource, LCDC_TFT_TypeDef*restrict psLayerDestRed,LCDC_DIMENSIONS_TypeDef sDim);
IMAGPROC_nStatus IMAGEPROC__en16bRGBScale_8bGreenPartialScale(LCDC_TFT_TypeDef *restrict psLayerSource, LCDC_TFT_TypeDef*restrict psLayerDestRed,LCDC_DIMENSIONS_TypeDef sDim);
