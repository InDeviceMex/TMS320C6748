...
#pragma DATA_ALIGN(MAIN__u16ProcessingBuffer, 8)
...
*/
    ...
    while(1)
    {
        ...
        //IMAGEPROC__en16bUmbral(&MAIN_sSubLayerBG_Generic[15],&MAIN_sSubLayerBG_Generic[15],DimProcessing,0x7204,0xE,0x14,0xb);
