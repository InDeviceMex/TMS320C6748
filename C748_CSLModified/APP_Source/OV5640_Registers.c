...
//Tabla de parámetros de configuración de compensación de exposición EV, admite 7 niveles
const uint8_t OV5640_u8ValueEXPOSURE[7][6]=
{
...
//Tabla de parámetros del modo de luz, compatible con 5 modos
const uint8_t OV5640_u8ModeLIGHT[5][7]=
{
...
const uint8_t OV5640_u8ValueSATURATION[7][6]=
{
...
const uint8_t OV5640_u8ValueSPECIALEFFECTS[7][3]=
{
    0X06, 0x40, 0X10, // normal
    0X1E, 0xA0, 0X40, // color frío
    0X1E, 0x80, 0XC0, // color cálido
    0X1E, 0x80, 0X80, // blanco y negro
    0X1E, 0x40, 0XA0, // amarillo
    0X40, 0x40, 0X10, // color inverso
    0X1E, 0x60, 0X60, // verde
};

// Configuración JPEG.7.5 cuadros
// Soporte máximo para salida de imagen JPEG 2592 * 1944
const uint16_t OV5640_u16RegistersJPEG[][2]=
{
...
// Configuración RGB565.15 cuadros
// Soporte máximo 1280 * 800 RGB565 salida de imagen
const uint16_t OV5640_u16RegistersRGB565[45][2]=
{
    0x4300, 0X6F,
    0X501F, 0x01,
    // 1280x800, 15fps
...
//Tabla de secuencia de registro de inicialización OV5640
const uint16_t OV5640_u16RegistersInit[208][2]=
{
 ...
 // 24MHz input clock, 24MHz PCLK
    ...
    0x3634, 0x40,
    0x3622, 0x01,
    // 50/60Hz detection 50/60Hz Franja ligera que filtra
    ...
    // AEC target Control de exposición automática
    ...
    // Lens correction for ? Compensación de la lente
    0x5800, 0x23,
    0x5801, 0x14,
    0x5802, 0x0f,
    0x5803, 0x0f,
    ...
    // UV adjust UV Ajuste de saturación de color
    ...
    // CIP Afilado y reducción de ruido
    ...
    //Configuraciones autoadhesivas
    0x4740, 0X21, //VSYNC Altamente eficaz
};



//Configuración de inicialización de enfoque automático
const uint8_t OV5640_u8ConfigAF[4077] =
{
