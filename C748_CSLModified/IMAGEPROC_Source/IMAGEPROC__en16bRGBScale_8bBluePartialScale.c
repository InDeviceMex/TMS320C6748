/*
 * IMAGEPROC__en16bRGBScale_8bBluePartialScale.c
 *
...
#define OPT (16)
IMAGPROC_nStatus IMAGEPROC__en16bRGBScale_8bBluePartialScale(LCDC_TFT_TypeDef *psLayerSource, LCDC_TFT_TypeDef*psLayerDestBlue,LCDC_DIMENSIONS_TypeDef sDim)
{
    ...
    for(s32Index=0;s32Index<(u16DimHeight*u16DimWidth)+u8Mod;s32Index++)
    {
        ...
        *((uint8_t*)pu8LayerDestBlue)=(*((uint8_t*)pu16LayerSource)&0x001F);
        pu16LayerSource++;
        pu8LayerDestBlue++;
    }
